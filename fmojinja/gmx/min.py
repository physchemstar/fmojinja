...
"""
	...
	def set_arguments(cls, p: ArgumentParser) -> ArgumentParser:
		...
		p.add_argument("-def1", "--define1", action="store_const", const="-DPOSRES1", default=" ", help="define")
		p.add_argument("-def2", "--define2", action="store_const", const="-DPOSRES2", default=" ", help="define")
		...
		p.add_argument("-nt", "--ns_type", default="grid", help="Method to determine neighbor list (simple, grid)")
